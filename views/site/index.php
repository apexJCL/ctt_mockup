    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col s12 m6 center hvr-underline-from-left">
                ...
                <h4 class="roboto-thin white-text">Perfiles</h4>
            </div>
            <div class="col s12 m6 center hvr-underline-from-left">
                <i class="material-icons md-96 cyan-text">add</i>
                <h4 class="roboto-thin white-text">Crear</h4>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col s12 m4 center hvr-grow-rotate">
                ...
                <h4 class="roboto-thin white-text">Facturas</h4>
            </div>
            <div class="col s12 m4 center hvr-grow-rotate">
                <i class="material-icons md-96 cyan-text">subject</i>
                <h4 class="roboto-thin white-text">Pedidos</h4>
            </div>
            <div class="col s12 m4 center hvr-grow-rotate">
                <i class="material-icons md-96 cyan-text">toc</i>
                <h4 class="roboto-thin white-text">Presupuestos</h4>
            </div>
        </div>
    </div>
</div>